...
REALMAN_HIGH_PD_CFG.actuators["realman_shoulder"].damping = 500.0
REALMAN_HIGH_PD_CFG.actuators["realman_forearm"].stiffness = 1047.2
REALMAN_HIGH_PD_CFG.actuators["realman_forearm"].damping = 500.0
REALMAN_HIGH_PD_CFG.actuators["realman_hand"].stiffness = 1047.2
REALMAN_HIGH_PD_CFG.actuators["realman_hand"].damping = 300
