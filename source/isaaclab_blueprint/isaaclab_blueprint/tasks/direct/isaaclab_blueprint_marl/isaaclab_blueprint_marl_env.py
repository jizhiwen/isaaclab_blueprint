...
from .isaaclab_blueprint_marl_env_cfg import IsaaclabBlueprintMarlEnvCfg


class IsaaclabBlueprintMarlEnv(DirectMARLEnv):
    cfg: IsaaclabBlueprintMarlEnvCfg

    def __init__(self, cfg: IsaaclabBlueprintMarlEnvCfg, render_mode: str | None = None, **kwargs):
