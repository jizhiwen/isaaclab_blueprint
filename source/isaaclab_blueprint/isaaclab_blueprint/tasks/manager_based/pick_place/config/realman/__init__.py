...
res = gym.register(
    id="Template-Isaaclab-Blueprint-PickPlace-Cube-Realman-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_abs_env_cfg:RealmanCubePickPlaceEnvCfg",
    }
)

res = gym.register(
    id="Template-Isaaclab-Blueprint-PickPlace-Cube-Realman-IK-Abs-Dump-RGB-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_abs_dump_rgb_env_cfg:RealmanCubePickPlaceEnvCfg",
    }
)

gym.register(
    id="Template-Isaaclab-Blueprint-PickPlace-Cube-Realman-IK-Abs-Mimic-v0",
    entry_point=f"{__name__}.ik_abs_mimic_env:RealmanCubePickPlaceIKAbsMimicEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_abs_mimic_env_cfg:RealmanCubePickPlaceMimicEnvCfg",
    },
)

gym.register(
    id="Template-Isaaclab-Blueprint-PickPlace-Cube-Realman-IK-Abs-Mimic-Dump-RGB-v0",
    entry_point=f"{__name__}.ik_abs_mimic_env:RealmanCubePickPlaceIKAbsMimicEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_abs_mimic_dump_rgb_env_cfg:RealmanCubePickPlaceMimicEnvCfg",
    },
)
