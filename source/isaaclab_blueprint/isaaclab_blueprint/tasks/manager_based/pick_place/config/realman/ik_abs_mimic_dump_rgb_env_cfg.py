...
from isaaclab_blueprint.tasks.manager_based.pick_place.config.realman.ik_abs_dump_rgb_env_cfg import (
...
class RealmanCubePickPlaceMimicEnvCfg(RealmanCubePickPlaceEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "isaac_lab_realman_pick_place_ik_abs_blueprint_D0"
