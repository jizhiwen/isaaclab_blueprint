...
class RealmanCubePickPlaceIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    ...
    def target_eef_pose_to_action(
        ...
        if action_noise_dict is not None:
            noise = action_noise_dict["realman"] * torch.randn_like(pose_action)
            pose_action += noise
